...
profileclean:
	...
	@rm -f Hoaryfox.profdata *.profraw
...
clang-profile-use:
	llvm-profdata merge -output=Hoaryfox.profdata *.profraw
	$(MAKE) ARCH=$(ARCH) COMP=$(COMP) \
	EXTRACXXFLAGS='-fprofile-instr-use=Hoaryfox.profdata' \
