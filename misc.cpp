...
/// engine_info() returns the full name of the current Hoaryfox version. This
/// will be either "Hoaryfox <Tag> DD-MM-YY" (where DD-MM-YY is the date when
/// the program was compiled) or "Hoaryfox <Version>", depending on whether
/// Version is empty.
